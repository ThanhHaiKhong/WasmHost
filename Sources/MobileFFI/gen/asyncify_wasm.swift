...
fileprivate typealias UniffiRustFutureContinuationCallback = @convention(c) (UInt64, Int8) -> Void

fileprivate struct UniffiVTableCallbackInterfaceAsyncifyWasmProvider {
    let flowOptions: (UInt64, UnsafeMutablePointer<RustBuffer>, UnsafeMutablePointer<RustCallStatus>) -> Void
    let updateOptions: (UInt64, UnsafeMutablePointer<RustBuffer>, UnsafeMutablePointer<RustCallStatus>) -> Void
    let stateChanged: (UInt64, RustBuffer, UnsafeMutableRawPointer?, UnsafeMutablePointer<RustCallStatus>) -> Void
    let setSharedPreferences: (UInt64, RustBuffer, RustBuffer, UnsafeMutableRawPointer?, UnsafeMutablePointer<RustCallStatus>) -> Void
    let getSharedPreferences: (UInt64, RustBuffer, UnsafeMutablePointer<RustBuffer>, UnsafeMutablePointer<RustCallStatus>) -> Void
    let uniffiFree: (UInt64) -> Void
}
...
@_silgen_name("ffi_asyncify_wasm_uniffi_contract_version")
fileprivate func ffi_asyncify_wasm_uniffi_contract_version() -> UInt32

@_silgen_name("ffi_asyncify_wasm_rustbuffer_from_bytes")
fileprivate func ffi_asyncify_wasm_rustbuffer_from_bytes(_ bytes: ForeignBytes, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> RustBuffer

@_silgen_name("ffi_asyncify_wasm_rustbuffer_free")
fileprivate func ffi_asyncify_wasm_rustbuffer_free(_ buf: RustBuffer, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("uniffi_asyncify_wasm_fn_constructor_asyncifywasm_new")
fileprivate func uniffi_asyncify_wasm_fn_constructor_asyncifywasm_new(_ out_status: UnsafeMutablePointer<RustCallStatus>) -> UnsafeMutableRawPointer

@_silgen_name("uniffi_asyncify_wasm_fn_clone_asyncifywasm")
fileprivate func uniffi_asyncify_wasm_fn_clone_asyncifywasm(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> UnsafeMutableRawPointer

@_silgen_name("uniffi_asyncify_wasm_fn_free_asyncifywasm")
fileprivate func uniffi_asyncify_wasm_fn_free_asyncifywasm(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasm_call")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasm_call(_ ptr: UnsafeMutableRawPointer, _ cmd: RustBuffer) -> UInt64

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasm_start")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasm_start(_ ptr: UnsafeMutableRawPointer, _ path: RustBuffer, _ opts: RustBuffer) -> UInt64

@_silgen_name("ffi_asyncify_wasm_rust_future_poll_void")
fileprivate func ffi_asyncify_wasm_rust_future_poll_void(_ handle: UInt64, _ callback: @convention(c) (UInt64, Int8) -> Void, _ data: UInt64)

@_silgen_name("ffi_asyncify_wasm_rust_future_complete_void")
fileprivate func ffi_asyncify_wasm_rust_future_complete_void(_ handle: UInt64, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("ffi_asyncify_wasm_rust_future_free_void")
fileprivate func ffi_asyncify_wasm_rust_future_free_void(_ handle: UInt64)

@_silgen_name("ffi_asyncify_wasm_rust_future_poll_rust_buffer")
fileprivate func ffi_asyncify_wasm_rust_future_poll_rust_buffer(_ handle: UInt64, _ callback: @convention(c) (UInt64, Int8) -> Void, _ data: UInt64)

@_silgen_name("ffi_asyncify_wasm_rust_future_complete_rust_buffer")
fileprivate func ffi_asyncify_wasm_rust_future_complete_rust_buffer(_ handle: UInt64, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> RustBuffer

@_silgen_name("ffi_asyncify_wasm_rust_future_free_rust_buffer")
fileprivate func ffi_asyncify_wasm_rust_future_free_rust_buffer(_ handle: UInt64)

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasm_call")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasm_call() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasm_start")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasm_start() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_constructor_asyncifywasm_new")
fileprivate func uniffi_asyncify_wasm_checksum_constructor_asyncifywasm_new() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_fn_clone_asyncifywasmprovider")
fileprivate func uniffi_asyncify_wasm_fn_clone_asyncifywasmprovider(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> UnsafeMutableRawPointer

@_silgen_name("uniffi_asyncify_wasm_fn_free_asyncifywasmprovider")
fileprivate func uniffi_asyncify_wasm_fn_free_asyncifywasmprovider(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_flow_options")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_flow_options(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> RustBuffer

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_update_options")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_update_options(_ ptr: UnsafeMutableRawPointer, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> RustBuffer

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_state_changed")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_state_changed(_ ptr: UnsafeMutableRawPointer, _ state: RustBuffer, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_set_shared_preferences")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_set_shared_preferences(_ ptr: UnsafeMutableRawPointer, _ key: RustBuffer, _ value: RustBuffer, _ out_status: UnsafeMutablePointer<RustCallStatus>)

@_silgen_name("uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_get_shared_preferences")
fileprivate func uniffi_asyncify_wasm_fn_method_asyncifywasmprovider_get_shared_preferences(_ ptr: UnsafeMutableRawPointer, _ key: RustBuffer, _ out_status: UnsafeMutablePointer<RustCallStatus>) -> RustBuffer

@_silgen_name("uniffi_asyncify_wasm_fn_init_callback_vtable_asyncifywasmprovider")
fileprivate func uniffi_asyncify_wasm_fn_init_callback_vtable_asyncifywasmprovider(_ vtable: UnsafePointer<UniffiVTableCallbackInterfaceAsyncifyWasmProvider>)

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_flow_options")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_flow_options() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_update_options")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_update_options() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_state_changed")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_state_changed() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_set_shared_preferences")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_set_shared_preferences() -> UInt16

@_silgen_name("uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_get_shared_preferences")
fileprivate func uniffi_asyncify_wasm_checksum_method_asyncifywasmprovider_get_shared_preferences() -> UInt16
#endif
...
open func call(cmd: Data)async throws  -> Data  {
    return
        try  await uniffiRustCallAsync(
            ...
            pollFunc: { handle, callback, data in ffi_asyncify_wasm_rust_future_poll_rust_buffer(handle, callback, data) },
...
open func start(path: String?, opts: Options?)async throws   {
    return
        try  await uniffiRustCallAsync(
            ...
            pollFunc: { handle, callback, data in ffi_asyncify_wasm_rust_future_poll_void(handle, callback, data) },
            completeFunc: ffi_asyncify_wasm_rust_future_complete_void,
            freeFunc: ffi_asyncify_wasm_rust_future_free_void,
            liftFunc: { (_: Void) -> Void in return () },
            errorHandler: FfiConverterTypeAsyncifyWasmError.lift
        )
}
